                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">Vehicle Model</h4>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label for="productname">Model Type</label>
                                                ...
                                                <div class="col-sm-6">
                                                       <div class="form-group">
                                                           ...
                                                           $rescompany = mysqli_query($conn, $querycompany);
                                                               while($rowsscompany = mysqli_fetch_assoc($rescompany) )
                                                           {
                                                               $company	= $rowsscompany['company'];
                                                               $company_id	= $rowsscompany['id'];
                                                           ?>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <table id="datatable" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <?php 
												$quu1 = "select * from model ORDER BY model ASC";							
												$ress1 = mysqli_query($conn, $quu1);
												$i = 1;
												while($roww1 = mysqli_fetch_assoc($ress1))
												{
													$id1 = $roww1['id'];
													$departments = $roww1['model']; 													 
													$company_id = $roww1['company_id'];
											?>
...
if(isset($_POST['btnupdate']) )
	{
        ...
        $company= $_POST['company'];		
		 ...
		 $sqlb = mysqli_query($conn, "insert into model (model, company_id) values('$txtname', '$company')");
	
		  if($sqlb)
		  { ?>
			  <script>alert('Added successfully...');
				window.location.href = "vehicle_model.php";</script>  
		  <?php }
...
if(isset($_POST['btnModelUp']) )
	{
		...
		$idModel1 = $_POST['txtIDMod'];	
		 ...
		 $sqlb = mysqli_query($conn, "UPDATE `model` SET `model`='$txtnameMod', `company_id`='$idCompany' WHERE id='$idModel1 '");
								...
								<form method="post" action="" enctype="multipart/form-data">
									<div class="row">
                                        ...
                                        <div class="col-sm-6">
                                                       <div class="form-group">
                                                           <label for="company" class="control-label">Company</label>
                                                           <select class="form-control" id="company" name="idCompany" required="">
                                                               <option value="">Select</option>
                                                               
                                                           <?php
                                                               $querycompany1 = "select * from company ";
                                                   
                                                           $rescompany1 = mysqli_query($conn, $querycompany1);
                                                               while($rowsscompany1 = mysqli_fetch_assoc($rescompany1) )
                                                           {
                                                               $company1	= $rowsscompany1['company'];
                                                               $company_id1	= $rowsscompany1['id'];
                                                           ?>
                                                               <option value="<?php echo $company_id1; ?>"><?php echo $company1;?></option>

...
CREATE TABLE `admin_registration` (
  ...
  `admin_registration_date` date NOT NULL,
  `admin_level` int(11) NOT NULL COMMENT '1 -Super Admin / 2 - Sub Admin'
...
INSERT INTO `admin_registration` (`admin_id`, `admin_name`, `admin_email`, `admin_mobile`, `admin_pic`, `admin_address`, `admin_about`, `admin_password`, `admin_registration_date`, `admin_level`) VALUES
(1, 'Admin', 'admin@gmail.com', '', 'assets/images/avatar-1.jpg', 'Pune,41', ' Demo Text Demo Text Demo Text', '12345', '2019-08-28', 1);
...
INSERT INTO `agent` (`id`, `agent`, `contact_no`, `email`, `add`, `status`) VALUES
(5, 'sdfg', 2134567457, 'cdf@gmail.com', 'xcv', 0),
(7, 'gfg', 2134567111, 'cdf@gmail.com', 'ffbg', 0),
(8, 'fgg', 2134567457, 'admin@gmail.com', 'asfg', 0);
...
INSERT INTO `colour` (`id`, `colour`, `status`) VALUES
(1, 'Red', 1),
(2, 'Black', 1),
(3, 'Blue', 1);
...
CREATE TABLE `documents` (
  ...
  `rc_book` int(11) NOT NULL,
  `duplicate_rc` int(11) NOT NULL,
  `rc_particulars` int(11) NOT NULL,
  `transfer_deed` int(11) NOT NULL,
  `noc` int(11) NOT NULL,
  `hp_termination` int(11) NOT NULL,
  `insurance` int(11) NOT NULL,
  `contact_no_update` int(11) NOT NULL,
  `adhar_card` int(12) NOT NULL,
  `pan_card` int(11) NOT NULL,
...
INSERT INTO `documents` (`id`, `agent`, `date`, `vehicle`, `vehicle_no`, `rc_book`, `duplicate_rc`, `rc_particulars`, `transfer_deed`, `noc`, `hp_termination`, `insurance`, `contact_no_update`, `adhar_card`, `pan_card`, `payment`, `advance`, `pending`, `payment_method`, `status`) VALUES
(4, '5', '2022-03-16', 'Honda Shine', '0', 2, 2, 2, 2, 1, 1, 22, 1, 1, 1, 35, 32, 3, 'Phonepe', 1),
(5, '5', '2022-03-09', 'Honda Activ', '6543456', 3, 2, 2, 2, 1, 1, 15, 1, 1, 1, 29, 22, 7, 'Account Pay', 1),
(6, '5', '2022-03-22', 'Honda Shine', 'mh-12 56467', 2, 1, 2, 1, 1, 1, 1, 2, 1, 1, 13, 22, -9, 'Gpay', 1),
(7, '7', '2022-03-30', 'Honda Activ', 'mh-12 12345', 2, 5, 1, 1, 1, 5, 2, 5, 5, 6, 33, 20, 13, 'Account Pay', 1),
(8, '7', '2022-04-11', 'Honda Activ', 'mh-12 12345', 0, 0, 0, 1, 1, 5, 1, 1, 5, 1, 0, 4, 0, '', 1),
(9, '7', '2022-04-12', 'Honda Shine', 'MH 16 MF 76877', 0, 2, 2, 2, 5, 5, 5, 5, 3, 6, 37, 20, 17, '', 1),
(15, '7', '2022-04-20', 'Honda Shine', '6546', 2, 2, 2, 2, 1, 1, 5, 2, 3, 5, 25, 55, -5, 'Gpay', 1);
...
CREATE TABLE `enquiry` (
  ...
  `enq_dt` varchar(100) NOT NULL,
  `followup_dt` varchar(100) NOT NULL,
...
INSERT INTO `enquiry` (`id`, `f_name`, `address`, `mob`, `msg`, `enq_dt`, `followup_dt`, `remark`, `source`, `status`, `enq_status`, `emp_nm`, `trash`) VALUES
(3, 'kjhgfgh', 'gygj', '34354', 'xyz', '2022-04-11', '2022-04-20', ',gfbvbnm', '6', 2, '0', '', '0'),
(4, 'cjjhngf', 'sdfg', '34354', 'fgdfg', '2022-04-04', '2022-04-04', 'sdfgb', '5', 0, '1', '', '0'),
(5, 'kjhgfgh', 'sdfg', '34354', 'fdsestyufgjk', '11-04-2022', '20-04-2022', 'jygftf', '4', 0, '0', '', '0');

-- --------------------------------------------------------

--
-- Table structure for table `enquiry_feedback`
--

CREATE TABLE `enquiry_feedback` (
  `id` int(10) NOT NULL,
  `enq_id` varchar(40) NOT NULL,
...
--
-- Dumping data for table `enquiry_feedback`
--

INSERT INTO `enquiry_feedback` (`id`, `enq_id`, `feedback`, `enq_dt`, `followup_dt`, `status`) VALUES
(1, '1', 'fgf', '21-03-2022', '14-03-2022', '0'),
(2, '2', 'cvfc', '21-03-2022', '14-03-2022', '0'),
(3, '2', 'gfgfgfg', '13-03-2022', '16-03-2022', 'Selected'),
(4, '2', 'kjhgfdfgh', '07-03-2022', '23-03-2022', '1'),
(5, '3', ',gfbvbnm', '22-03-2022', '08-04-2022', '2'),
(6, '4', 'sdfgb', '18-03-2022', '04-04-2022', '1'),
(7, '3', '', '27-03-2022', '29-04-2022', 'Follow Up'),
(8, '5', 'jygftf', '11-04-2022', '20-04-2022', '0');
...
CREATE TABLE `enquiry_followup` (
  `id` int(10) NOT NULL,
  `enq_id` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `feed_id` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `follow_dt` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `enquiry_followup` (`id`, `enq_id`, `feed_id`, `follow_dt`, `status`) VALUES
(1, '1', '1', '04-04-2022', '0'),
(2, '2', '2', '14-03-2022', '0'),
(3, '3', '5', '08-04-2022', '0'),
(4, '4', '6', '04-04-2022', '1'),
...
INSERT INTO `fuel` (`id`, `fuel`, `status`) VALUES
(2, 'Petrol', 1),
(3, 'Diesel', 1),
(4, 'CNG', 1);
...
--
-- Table structure for table `invoice_paid`
--
...
--
-- Dumping data for table `invoice_paid`
--

INSERT INTO `invoice_paid` (`id`, `invoice_id`, `total_amount`, `paid_amount`, `pending_amount`, `remark`, `paid_status`, `payment_date`, `vehicle_status`) VALUES
(1, 3, 50, 25, 25, 'xyz', 0, '2022-03-21', 'Vehicle Seller'),
(2, 3, 50, 25, 25, 'xyz', 0, '2022-03-21', 'Vehicle Seller'),
(3, 3, 25, 25, 0, 'xyz', 0, '2022-03-21', 'Vehicle Seller'),
(4, 5, 700, 0, 700, '', 0, '2022-03-25', ''),
(5, 5, 700, 200, 500, 'gfghf', 0, '2022-03-21', 'Vehicle Seller'),
(6, 5, 500, 400, 100, 'gfghf', 0, '2022-03-21', 'Vehicle Seller'),
(7, 12, 700, 0, 700, '', 0, '2022-03-21', ''),
(8, 12, 700, 200, 500, 'xyz', 0, '2022-03-21', 'Vehicle Buyers'),
(9, 12, 500, 400, 100, 'gfghf', 0, '2022-03-30', 'Vehicle Buyers'),
(10, 12, 100, 50, 50, '', 0, '2022-03-31', 'Vehicle Buyers'),
(11, 12, 50, 25, 25, '', 0, '2022-03-31', 'Vehicle Buyers'),
(12, 0, 10, 0, 10, '', 0, '2022-04-08', ''),
(13, 13, 10, 0, 10, '', 0, '2022-04-08', ''),
(14, 14, 100, 0, 100, '', 0, '2022-04-06', ''),
(15, 15, 700, 0, 700, '', 0, '2022-04-07', ''),
(16, 0, 10, 0, 10, '', 0, '2022-04-13', ''),
(17, 0, 10, 0, 10, '', 0, '2022-04-13', ''),
(18, 0, 10, 0, 10, '', 0, '2022-04-13', ''),
(19, 0, 10, 0, 10, '', 0, '2022-04-13', ''),
(20, 0, 10, 0, 10, '', 0, '2022-04-13', ''),
(21, 0, 50, 0, 50, '', 0, '2022-04-12', ''),
(22, 16, 700, 0, 700, '', 0, '2022-04-13', ''),
(23, 0, 50, 0, 50, '', 0, '2022-03-28', ''),
(24, 6, 50, 0, 50, '', 0, '2022-03-28', ''),
(25, 7, 700, 0, 700, '', 0, '2022-04-09', ''),
(26, 8, 50, 0, 50, '', 0, '2022-04-10', ''),
(27, 17, 700, 0, 700, '', 0, '2022-04-20', ''),
(28, 18, 40000, 0, 40000, '', 0, '2022-07-06', ''),
(29, 9, 700, 0, 700, '', 0, '2022-07-14', ''),
(30, 10, 700, 0, 700, '', 0, '2022-07-15', '');
...
INSERT INTO `model` (`id`, `company_id`, `model`, `status`) VALUES
(1, 0, 'pulsar', 1),
(5, 2, 'Honda Activa', 0),
(6, 2, 'Honda Shine', 0);
...
--
-- Table structure for table `vehicle_buyers`
--

CREATE TABLE `vehicle_buyers` (
  `id` int(100) NOT NULL,
  `date` date NOT NULL,
  `contact_no` int(11) NOT NULL,
  ...
  `pan_num` int(11) NOT NULL,
  `company_id` int(11) NOT NULL,
  `model_id` int(11) NOT NULL,
  `colour_id` int(11) NOT NULL,
  `fuel_id` int(11) NOT NULL,
  `odometer_reading` int(11) NOT NULL,
  `year_mgf` int(11) NOT NULL,
  `resistration_num` varchar(100) NOT NULL,
  `resistration_date` date NOT NULL,
...
--
-- Dumping data for table `vehicle_buyers`
--

INSERT INTO `vehicle_buyers` (`id`, `date`, `contact_no`, `cust_name`, `cust_email`, `cust_add`, `country_id`, `state_id`, `city_id`, `pincode`, `gst_num`, `pan_num`, `company_id`, `model_id`, `colour_id`, `fuel_id`, `odometer_reading`, `year_mgf`, `resistration_num`, `resistration_date`, `engine_number`, `chassis_number`, `payment`, `advance`, `pending`, `payment_method`, `status`) VALUES
(13, '2022-04-08', '7264967939', 'vrushali Dhokane', 'admin@gmail.com', 'Umbare', 100, 745, 3494, 414105, 45565, 2147483647, 2, 6, 1, 2, 10, 2002, '4567', '2022-04-14', '546', '222', 10, 50, -40, 'Phonepe', 0),
(17, '2022-04-20', '7264967939', 'vrushali', 'admin@gmail.com', 'Umbare', 100, 744, 0, 454565, 45565, 456546, 2, 5, 1, 3, 44, 0, 'mh 17 22', '2022-04-20', '546', '4546', 700, 50, 650, 'Phonepe', 1),
(18, '2022-07-06', '34354', 'sunita', 'admin@gmail.com', 'rahuri', 0, 0, 0, 0, 0, 0, 2, 5, 0, 0, 10, 2024, '4567', '2022-07-07', '546', '222', 40000, 22, 39978, 'Phonepe', 1);

-- --------------------------------------------------------

--
-- Table structure for table `vehicle_seller`
--
...
--
-- Dumping data for table `vehicle_seller`
--

INSERT INTO `vehicle_seller` (`id`, `date`, `contact_no`, `cust_name`, `cust_email`, `cust_add`, `country_id`, `state_id`, `city_id`, `pincode`, `gst_num`, `pan_num`, `company_id`, `model_id`, `colour_id`, `fuel_id`, `odometer_reading`, `year_mgf`, `resistration_num`, `resistration_date`, `engine_number`, `chassis_number`, `payment`, `advance`, `pending`, `payment_method`, `status`) VALUES
(7, '2022-04-09', '7264967939', 'vrushali', 'admin@gmail.com', 'Umbare', 100, 733, 0, 454565, 12345, 56789, 2, 6, 2, 2, 44, 2026, '6546', '2022-04-06', '546', '4546', 700, 55, 645, 'Gpay', 1),
(8, '2022-04-12', '1234567890', 'Sunita', 'admin@gmail.com', 'Umbare', 100, 742, 0, 414105, 12345, 2147483647, 2, 5, 2, 2, 44, 0, '6546', '2022-04-13', '111', '4546', 50, 55, -5, 'Gpay', 1),
(9, '2022-07-14', '2134567', 'ANITA', 'shreeswamisamarth.engg@yahoo.com', 'ffbg', 0, 0, 0, 0, 0, 0, 2, 6, 0, 0, 44, 2029, '4567', '2022-07-11', '111', '222', 700, 20, 680, 'Phonepe', 1);
...
--
-- Indexes for table `enquiry_feedback`
--
ALTER TABLE `enquiry_feedback`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `enquiry_followup`
--
ALTER TABLE `enquiry_followup`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `vehicle_buyers`
--
ALTER TABLE `vehicle_buyers`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `vehicle_seller`
--
ALTER TABLE `vehicle_seller`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `enquiry_feedback`
--
ALTER TABLE `enquiry_feedback`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `enquiry_followup`
--
ALTER TABLE `enquiry_followup`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
-- AUTO_INCREMENT for table `invoice_paid`
--
ALTER TABLE `invoice_paid`
...
--
-- AUTO_INCREMENT for table `vehicle_buyers`
--
ALTER TABLE `vehicle_buyers`
  MODIFY `id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT for table `vehicle_seller`
--
ALTER TABLE `vehicle_seller`

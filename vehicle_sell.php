                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">SELLER CUSTOMERS</h4>

                                    <div class="page-title-right">
                                       <div class="text-sm-right">
											<a  class="btn btn-success btn-rounded waves-effect waves-light mb-2 mr-2  " href="add_sellers.php">
                                ...
                                <div class="card">
                                    <div class="card-body">
										<div class="table-responsive">
					                        ...
					                        $srNo = 1;
                        					$query = "select * from vehicle_seller order by id desc";
...
?>
													...
													<tr> 
														...
														<td>
                                                        <a href="seller-update.php?u_id=<?php echo $id1; ?>" class="btn btn-outline-success waves-effect waves-light"><i class="fas fa-pencil-alt "></i> </a>

                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">Seller Details</h4>
                                    ...
                                    <div class="row">
                                                 ...
                                                 <div class="col-sm-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="textdate" id="textdate" type="date" class="form-control" required>
                                                    </div>  
                                                </div>
                                                <div class="col-sm-3">
                                                    <div class="form-group">
                                                        <label for="productname">Contact No</label>
                                                        <input name="txtContact" id="txtContact" type="text" class="form-control" required>
                                                    </div>  
                                                </div>
												<div class="col-sm-3">
                                                    <div class="form-group">
                                                        <label class="control-label">Customer Name</label>
                                                        <input  name="txtNm" id="txtNm" type="text" class="form-control" required>
                                                    </div>  
                                                </div>
												<div class="col-sm-3">
                                                    <div class="form-group">
                                            ...
                                            <div class="row">
												<div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="txtAddBilling" id="txtAddBilling" type="text" class="form-control">
                                                    </div>  
                                                </div>
                                            </div>
							   ...
							   <div class="card">
                                ...
                                <div class="col-sm-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="txtodometer" id="txtodometer" type="text" class="form-control">
                                                    </div>  
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="txtnumber" id="txtnumber" type="text" class="form-control">
                                                    </div>  
                                                </div> 
												 ...
												 <div class="col-sm-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="txtdate" id="txtdate" type="date" class="form-control">
                                                    </div>  
                                                </div>
                                                ...
                                                <div class="col-sm-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="txtengine" id="txtengine"  type="text" class="form-control">
                                                    </div>  
                                                </div> 
 												 ...
 												 <div class="col-sm-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="txtchassis" id="txtchassis" type="text" class="form-control">
                                                    </div>  
                                                </div>
                                            </div>
									</div>
...
$sqlb = mysqli_query($conn, "INSERT INTO vehicle_seller
 ...
 ('$p_id', '0', '$txtpayment','$txtpayment', '','$textdate')");
			  ...
			  { ?>
				  <script>alert('Added successfully...');
					window.location.href = "vehicle_sell.php";</script>  
			  <?php }
}   
